...
app.use("/api/careerhub", careerhubRoutes);
...
app.locals.io = attachRealtime(server);
server.listen(PORT, () => {
  console.log(`Chuka Connect backend (+ realtime) running on http://localhost:${PORT}`);
});
